...
import whatMatter from './assests/whatMatter.jpeg';
              ...
              <div className="col-12 col-xl-11">
                ...
                <div className="row gy-4 gy-md-0 gx-xxl-5">
                  ...
                  <div className="col-12 col-md-6">
                    <div className="d-flex">
                      <div className="me-4 text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-houses-fill" viewBox="0 0 16 16">
